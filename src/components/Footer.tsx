      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <div className="flex gap-4">
            <a href="https://www.facebook.com/share/18miGRz95a/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="hover:text-[#5ECFCF] transition-colors"><IconFacebook /></a>
            <a href="#" aria-label="Instagram" className="hover:text-[#5ECFCF] transition-colors"><IconInstagram /></a>
            <a href="https://www.tiktok.com/@visum.akademie" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="hover:text-[#5ECFCF] transition-colors"><IconTikTok /></a>
